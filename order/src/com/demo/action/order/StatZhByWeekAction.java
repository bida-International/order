...
@Controller("order.statZhByWeekAction")
@Scope("prototype")
public class StatZhByWeekAction extends BaseAction {
	...
	public String execute() {
		...
		statList = orderStatZhDao.getStatList(zhanghaoId, 2, statBeginTime, statEndTime);
	...
	private void createOrderAmountChart() {
		TimeSeries series = new TimeSeries("订单数量", Week.class);
	...
	private void createTotalMoneyChart() {
		TimeSeries series = new TimeSeries("订单金额", Week.class);
