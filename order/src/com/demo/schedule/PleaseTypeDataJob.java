...
import com.demo.biz.dhgate.PleaseTypeApiBiz;
import com.demo.dao.ZhangHaoDao;
import com.demo.entity.ZhangHao;

public class PleaseTypeDataJob implements InitializingBean {
	...
	@Resource
	private PleaseTypeApiBiz pleaseTypeApiBiz;
	@Resource
		...
		try {
			...
			for (ZhangHao zhangHao : zhangHaos) {
				if (zhangHao.getAccount_type().equals(DhCommonApiBiz.ACCOUNT_TYPE)) { // 敦煌账号
					// 同步订单数据
					String result = pleaseTypeApiBiz.autoPleaseTypeOrders(zhangHao);
