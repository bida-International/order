...
public class ApiCacheUtils {
	private static final Logger logger = LoggerFactory.getLogger(ApiCacheUtils.class);
	private static Object lockObject = new Object();
	private static ApiCacheUtils instance = null;
	public static CacheManager cacheManager = null;
	
	public static final String CACHE_NAME = "ApiCacheUtils";
	 ...
	 */
	public static ApiCacheUtils getInstance() {
		if (instance == null) {
