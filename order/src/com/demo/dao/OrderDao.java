...
public interface OrderDao extends BaseDao<OrderTable,Long>
{
    ...
    //业务得到修改订单
    public abstract String getYeWuOrder(String s, String s1, Long s2, String s3,String time,String time1);

    public abstract List<OrderTable> getWanChengOrder(String s);
    //管理员查看总金额
    public abstract List<OrderTable> getAllMoney(String s, String s1, String s2, String s3,String danhao,String sumaitong,String bianma,Long leimu);
    //管理员查看总运费
    public abstract List<OrderTable> getAllYunFei(String s, String s1, String s2, String s3,String danhao,String sumaitong,String bianma,Long leimu);
    //管理员查看总货款
    public abstract List<OrderTable> getAllHuoKuan(String s, String s1, String s2, String s3,String danhao,String sumaitong,String bianma,Long leimu);
    //管理员查看总退款
    public abstract List<OrderTable> getAllTuiKuan(String s, String s1, String s2, String s3,String danhao,String sumaitong,String bianma,Long leimu);
    //管理员查看纠纷个数
    public abstract List<OrderTable> getJiuFenNum(String s, String s1, String s2, String s3,String danhao,String sumaitong,String bianma,Long leimu);
    ...
    //管理员查看运费为空
    public abstract List<OrderTable> getYunFeiNullNum(String s, String s1, String s2, String s3,String danhao,String sumaitong,String bianma,Long leimu);
    //管理员查看货款为空
    public abstract List<OrderTable> getHuoKuanNullNum(String s, String s1, String s2, String s3,String danhao,String sumaitong,String bianma,Long leimu);
    //业务查询运费为空
    ...
    //查看采购未完成订单
    public abstract String getCaiGouWeiWanCheng(String s,Long caigouyuan);
    //采购管理员完成订单
    ...
    //管理员查看纠纷总额
    public abstract List<OrderTable> getCaiGouAllJiuFenMoney(String s, String s1, String s2, String s3,String danhao,String sumaitong,String bianma,Long leimu);
    ...
    public abstract List<OrderTable> getZongLiRun(String s, String s1, String s2, String s3,String danhao,String sumaitong,String bianma,Long leimu);
  ...
  //本公司订单号查询
    ...
    //总的未入账
    public List<OrderTable> getWeiRuZhang(String orderId, String time, String time1, String zhanghao,String danhao,String sumaitong,String bianma,Long leimu);
    //查询全部未入账
