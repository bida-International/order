 ...
 function myguonei(){
		...
		if(flag<1){
			...
			if(bool){
			  ...
			  location.href="pa!upweikong.do?bulletinId="+bulletinId+"&guoneiyunshu="+sel+"&userid="+user+"&pageNumber="+${pageNumber}+"&pager.offset="+${pageNumber*10-10};
			}else{
				return false;
			}
		}
	 ...
	 function quan()
	 {
	  ...
	  function mywancheng(){
	 	var items=document.getElementsByTagName("input"); 
		var lujing = "pa!zhijiefangru.do?pageNumber="+${pageNumber}+"&pager.offset="+${pageNumber*10-10};
...
<m:frame>
	<s:form action="pa!getImportOrders.do" enctype="multipart/form-data" method="post">
		<table>
			<tr>
	...
	<form action="pa!getNumberisempty.do" name="forms" id="forms" method="post" onsubmit="return as()">
	<table border="1">
		<tr>
  ...
  <table border="1" width="1150px" cellspacing="0" style="float:left">
    <tr>
      <td colspan="13" align="center"><strong>单号为空订单</strong></td>
    </tr>
    <tr>
    <td colspan="13">
 ...
 <tr> <td colspan="13" align="center">
    	...
    	<pg:pager url="" items="${pageBean.allRow}" export="currentPageNumber=pageNumber" maxPageItems="10"> 
          ...
          <tr>
          	<td style="color:#ff0000;" colspan="12">
          			使用说明：
					<ol>
						<li>先导出全部单号为空订单</li>
						<li>用供运商去到阿里 淘宝 等等 查询  运输单号和供运商</li>
						<li>把运输单号和快递方式添加到Excel里面</li>
					</ol>
          	</td>
          </tr>
  </table>
