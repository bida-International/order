...
<script>
 function mywancheng(){
		...
		var lujing = "pa!wanchengorder.do?pageNumber="+${pageNumber}+"&pager.offset="+${pageNumber*10-10};
	 ...
	 function quan()
	 {
	  ...
	  function seldaifaqu(){
	  	...
	  	if(confirm("确定？")){
	  		window.location = "pa!seldaifangqu.do?guoneidanhao="+guoneidanhao+"&pageNumber="+${pageNumber}+"&pager.offset="+${pageNumber*10-10};
	  	}
	...
	${msg}
	<form action="pa!getDaiFaHuo.do" method="post" name="forms" id="forms">
  ...
  <table border="1" width="1000px" cellspacing="0" style="float:left">
    <tr>
      <td colspan="13" align="center"><strong>待发货订单</strong></td>
    </tr>
    <tr>
    <td colspan="13">
