...
<body>
${msg}
  <form action="caigou!upcaigoudaifahuo.do?ordertable.id=${updateIds.id}&pageNumber=${pageNumber}&pager.offset=${pageNumber*10-10}" method="post" id="myform" onsubmit="return as()">
  <input type="hidden"  name="ordertable.caigouyuan" value="${updateIds.caigouyuan}"/>
  <table border="1"  class="datagrid2" id="list" width="600px" cellspacing="0" style="float:left">
    <tr>
	...
	<tr>
     <td width="80" align="right"><span class="STYLE2">采购时间</span></td>
      <td><input type="text" name="ordertable.caigoutime" id="mydate" onfocus="WdatePicker()" title="采购时间" value="${updateIds.caigoutime}"/></td>
	</tr>
	<tr>
