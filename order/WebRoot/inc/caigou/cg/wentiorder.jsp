	  ...
	  function fanhuidaifahuo(){
		...
		if(flag<1){
			...
			if(bool){
			  ...
			  location.href="caigou!fhdaifahuo.do?bulletinId="+bulletinId+"&pageNumber="+${pageNumber}+"&pager.offset="+${pageNumber*10-10};
			}else{
				return false;
			}
		}
...
<m:frame>
<form action="caigou!getIssuesOrders.do" name="forms" id="forms" method="post">
