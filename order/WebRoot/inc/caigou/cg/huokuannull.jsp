...
<m:frame>
	...
	<form action="caigou!huokuannull.do" method="post" onsubmit="return as()" name="forms" id="forms">
  <table border="1"  class="datagrid2" id="list" cellspacing="0" width="1100px" style="float:left">
    <tr>
      <td colspan="16" align="center"><strong>货款为空</strong></td>
    </tr>
    <tr>
    <td colspan="16">
    ...
    <tr align="center">
     <td width="154"><span class="STYLE2">日期</span></td>
      ...
      <td width="120"><span class="STYLE2">货款</span></td>
    ...
    <s:iterator value="pageBean.list" var="i">
      <tr align="center">
	    ...
	    <td><s:property value="getZhangHaoId(#i.zhanghaoId)"/></td>
	   	 ...
	   	 <td><textarea>${i.remark}</textarea></td>
	   	<td><a href="caigou!uphuokuan.do?ordertable.id=${i.id}&pageNumber=${pageNumber}&pager.offset=${pageNumber*10-10}">修改订单 </a></td> 	      
     </tr>    
   </s:iterator>
