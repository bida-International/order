...
function as(){
	...
	function tiaozhuan(){
		...
		location.href = "caigouadmin!thLiRunAdmin.do?pager.offset="+(pageNumber*10-10)+"&pageNumber="+pageNumber;
    }
</script>
<m:frame>
<s:form action="caigouadmin!thLiRunAdmin.do"  onsubmit="return as()" >
  <table border="1" width="1100px" cellspacing="0" style="float:left">
    <tr>
    ...
    <s:iterator value="pageBean.list" var="sd">
      ...
      <tr>     
        ...
        <pg:pager url="caigouadmin!thLiRunAdmin.do" items="${pageBean.allRow}" export="currentPageNumber=pageNumber" maxPageItems="10"> 
 		 <pg:first> 
