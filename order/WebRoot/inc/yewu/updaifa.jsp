...
<m:frame>
  ...
  <form action="yewu!updatedaifa.do?ordertable.id=${updateIds.id}&pageNumber=${pageNumber}&pager.offset=${pageNumber*10-10}" method="post" id="myform" onsubmit="return as()">
  ...
  <table border="1" cellspacing="0" width="300px" style="float:left">
    ...
    <tr>
     ...
     <td width="54" align="right"><span class="STYLE2">运费</span></td>
      <td><input name="ordertable.yunfei" type="text" id="yunfei" size="12" title="运费" value="${updateIds.yunfei}"></td>
	</tr>
    <tr>    
