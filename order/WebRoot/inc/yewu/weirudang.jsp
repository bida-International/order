...
<m:frame>
	...
	${msg}
	<form action="yewu!getWeiRuDang.do" name="forms" id="forms" method="post" onsubmit="return as()">
  <table border="1" width="1155px" cellspacing="0" style="float:left">
    <tr>
      <td colspan="12" align="center"><strong>显示未入单订单</strong></td>
    </tr>
    <tr>
    <td colspan="12">
    ...
    <tr align="center">
     <td width="100"><span class="STYLE2">日期</span></td>
      ...
      <td width="80"><span class="STYLE2">货款</span></td>
       <td width="100"><span class="STYLE2">速卖通地址</span></td>
    ...
    <s:iterator value="pageBean.list" var="i">
      <tr align="center">
	    ...
	    <td>
	   	 ...
	   	 <td><a href="yewu!upweirudang.do?ordertable.id=${i.id}&pageNumber=${pageNumber}&pager.offset=${pageNumber*10-10}">修改订单</a>
	   	 /<a href="yewu!adminfanhui.do?ordertable.id=${i.id}&pageNumber=${pageNumber}&pager.offset=${pageNumber*10-10}">返回给管理员</a>
	   	 </td>    
     </tr>    
   </s:iterator>
    <tr>     
