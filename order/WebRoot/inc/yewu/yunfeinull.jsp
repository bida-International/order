...
<m:frame>
	...
	${msg}
	<form action="yewu!getYunFeiNull.do" method="post" name="forms" id="forms" onsubmit="return as()">
  <table border="1" width="1000px" cellspacing="0" style="float:left">
    <tr>
      <td colspan="7" align="center"><strong>运费为空</strong> <a href="exportOrder!daochu.do">导出运费为空</a></td>
    </tr>
    <tr>
    <td colspan="7">
    ...
    <s:iterator value="pageBean.list" var="i">
      <tr align="center">
	    ...
	    <td><s:property value="getZhangHaoId(#i.zhanghaoId)"/></td>
	   	 ...
	   	 <td><a href="yewu!upywyunfei.do?ordertable.id=${i.id}&pageNumber=${pageNumber}&pager.offset=${pageNumber*10-10}">修改订单</a></td>	      
     </tr>    
   </s:iterator>
    <tr>     
