...
<m:frame>
  ...
  <form action="yewu!updateweirudang.do?ordertable.id=${yeWuId.id}&pageNumber=${pageNumber}&pager.offset=${pageNumber*10-10}" method="post" id="myform" onsubmit="return as()">
  <input type="hidden" name="ordertable.caigouyuan" value="${yeWuId.caigouyuan}"/>
  <table border="1" cellspacing="0" width="380px" style="float:left">
    <tr>
    ...
    <tr>
     ...
     <td width="70" align="right"><span class="STYLE2">供运商</span></td>
      <td><input name="ordertable.gongyunshang" type="text" id="gongyunshang " size="12" title="供运商  " value="${yeWuId.gongyunshang}"></td>
	</tr>
	 <tr>
     <td width="70" align="right"><span class="STYLE2">修改运费</span></td>
