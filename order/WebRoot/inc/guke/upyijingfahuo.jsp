...
<m:frame>
${msg}
  <form action="guke!updateyijingfahuo.do?orderTable.id=${updateId.id}&pageNumber=${pageNumber}&pager.offset=${pageNumber*10-10}" method="post" id="myform" onsubmit="return as()">
  <table border="1" width="300px" cellspacing="0" style="float:left">
    ...
    <tr>
	 ...
	 <tr>
     <td width="54" align="right"><span class="STYLE2">国内运输方式</span></td>
