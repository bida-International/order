...
<script type="text/javascript">
 	...
 	function myshow()
	{
		...
		window.location = "test!allXieXin.do?usertype="+usertype;
	}
	function usertype()
	{
		var usertype = document.getElementById("usertype").value;
		...
		window.location = "test!addXieXin.do?usertype="+usertype+"&userid="+userid+"&title="+title+"&neirong="+neirong;
	}
</script>
<m:frame>
 ...
 <div>
  ...
  <tr>
  	...
  	<td>
  	 <select name="usertype" id="usertype" onchange="myshow()">
 	...
 	<option value="7" ${usertype==7?('selected="selected"'):('')}>管理员</option>
 	</select>
  	</td>
  </tr>
    <tr>
