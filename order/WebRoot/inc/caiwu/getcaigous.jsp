...
<m:frame>
	<script type="text/javascript">
		...
		function myshow()
		{
			...
			window.location = "caiwu!getFilter.do?usertype="+usertype;
		}
	</script>
	<form action="caiwu!getFilter.do" method="post" name="forms" id="forms">
  <table border="1"  class="datagrid2" width="1100px" id="list" cellspacing="0" style="float:left">
    <tr>
      <td colspan="13" align="center"><strong>采购订单</strong></td>
    </tr>
     <tr>
    <td colspan="13">
