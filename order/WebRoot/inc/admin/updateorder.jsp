...
<m:frame>
${msg}
  <form action="admin!updatedingdan.do?ordertable.id=${updateId.id}&pageNumber=${pageNumber}&pager.offset=${pageNumber*10-10}" method="post" id="myform" onsubmit="return as()">
  ...
  <table border="1" cellspacing="0"  class="datagrid2" id="list" style="float:left">
    ...
    <tr>
     <td width="70" align="right"><span class="STYLE2">订单号</span></td>
      ...
      <td><input name="ordertable.yunshu" type="text" id="yunshu" title="类目"  value="${updateId.yunshu}"></td>
     </tr>
     <tr>
      <td width="64"  align="right"><span class="STYLE2">运费</span></td>
       <td><input name="ordertable.yunfei" type="text" id="yunfei" size="7" title="运费" style="ime-mode:disabled" value="${updateId.yunfei}"></td>
       <td width="54"  align="right"><span class="STYLE2">速卖通</span></td>
       <td><input name="ordertable.guojia" type="text" id="guojia" title="速卖通"  value="${updateId.guojia}"></td>
     </tr>
      <tr>
      <td width="54"  align="right"><span class="STYLE2">备注</span></td>
       <td><textarea name="ordertable.remark">${updateId.remark}</textarea></td>
       <td width="54"  align="right"><span class="STYLE2">汇率</span></td>
       <td><input name="ordertable.huilv" type="text" id="huilv" size="7" title="汇率" style="ime-mode:disabled" value="${updateId.huilv}"></td>
      </tr>
      
      <tr>
      <td width="70"  align="right"><span class="STYLE2">供运商</span></td>
       <td><input name="ordertable.gongyunshang" type="text" id="gongyunshang" size="12" title="供运商"  value="${updateId.gongyunshang}"></td>
       <td width="54"  align="right"><span class="STYLE2">退款</span></td>
      <td><input name="ordertable.tuikuan" type="text" id="tuikuan" size="7" title="退款" style="ime-mode:disabled" value="${updateId.tuikuan}"></td>
      </tr>
      <tr>
      <td width="100"  align="right"><span class="STYLE2">是否上网</span></td>
      <td>
      <s:if test="%{updateId.shangwang==0 || updateId.shangwang == null">
      ...
      <s:if test="%{updateId.shangwang==1}">
      	...
      	<td>
      	<s:if test="%{updateId.qianshou==0 || updateId.qianshou == null}">
       ...
       <tr>
      	<td width="100"  align="right"><span class="STYLE2">是否入账</span></td>
      	 <td>
      	 <s:if test="%{updateId.ruzhang==0 || updateId.ruzhang == null}">
     	 ...
     	 <td><input name="ordertable.danhao" type="text" id="danhao" size="12" title="运输单号" style="ime-mode:disabled" value="${updateId.danhao}"></td>
       </tr>  
       <tr>
     
       	<td width="100"  align="right"><span class="STYLE2">是否纠纷</span></td>
      	 <td>
      	 <s:if test="%{updateId.jiufen==0 || updateId.jiufen == null}">
         ...
         <tr>
	      ...
	      <td>
		      <s:if test="%{updateId.tuihuo==0 || updateId.tuihuo == null}">
	      	...
	      	<td width="64"  align="right"><span class="STYLE2">货款</span></td>
	       	<td>
	       	<input name="ordertable.huokuan" value="${updateId.huokuan}" type="text" id="huokuan" size="7"  title="货款" style="ime-mode:disabled" onkeyup="onlyNumber(this)"  onblur="onlyNumber(this)" onKeyPress="if((event.keyCode<48 || event.keyCode>57) && event.keyCode!=46 || /\.\d\d$/.test(value))event.returnValue=false">
	      </td>
      ...
      <tr>
       ...
       <td>
       <input name="ordertable.money" value="${updateId.money}" type="text" id="huokuan" size="7"  title="金额" style="ime-mode:disabled" onkeyup="onlyNumber(this)"  onblur="onlyNumber(this)" onKeyPress="if((event.keyCode<48 || event.keyCode>57) && event.keyCode!=46 || /\.\d\d$/.test(value))event.returnValue=false">
       </td>
       	<td width="64"  align="right"><span class="STYLE2">编码</span></td>
	       	<td>
	       	<input name="ordertable.bianma" value="${updateId.bianma}" type="text" id="huokuan" size="7"  title="产品编码" style="ime-mode:disabled">
	      </td>
     </tr>
    <tr>   
