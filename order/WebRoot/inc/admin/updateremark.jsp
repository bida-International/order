...
<m:frame>
${msg}
  <form action="admin!upAdminRemark.do?ordertable.id=${updateId.id}&pageNumber=${pageNumber}&pager.offset=${pageNumber*10-10}" method="post" id="myform" onsubmit="return as()">
  <input type="hidden" name="ordertable.caigouyuan" value="${updateId.caigouyuan}"/>
  <table border="1" width="200px" cellspacing="0"  class="datagrid2" id="list" style="float:left">
    <tr>
