...
<m:frame>
	...
	<form action="admin!getChaHuoKuanNull.do" method="post">
  <table border="1"  class="datagrid2" id="list" cellspacing="0" style="float:left">
    <tr>
      <td colspan="11" align="center"><strong>货款为空</strong></td>
    </tr>
     <tr>
    <td colspan="11">
  ...
  <tr> 
        ...
        <pg:pager url="admin!getChaHuoKuanNull.do" items="${pageBean.allRow}" export="currentPageNumber=pageNumber" maxPageItems="10"> 
 		 <pg:first> 
