...
<m:frame>
${msg}
  <form action="admin!upWenTiRemark.do?ordertable.id=${updateId.id}&pageNumber=${pageNumber}&pager.offset=${pageNumber*10-10}" method="post" id="myform" onsubmit="return as()">
  <input type="hidden" name="ordertable.caigouyuan" value="${updateId.caigouyuan}"/>
  <table border="1"  class="datagrid2" id="list" cellspacing="0" width="200px" style="float:left">
    <tr>
