    ...
    <s:iterator begin="1" end="5" status="t">
      <tr align="center">
	    ...
	    <td><input name="guojia" type="text" id="guojia" title="国家"/></td>	
	     <td><input name="money" type="text" id="money" title="资费"/></td> 
     </tr>    
   </s:iterator>
    <tr>    
