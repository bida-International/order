...
<m:frame>
  ...
  <form action="admin!upremark.do?ordertable.id=${updateId.id}&pageNumber=${pageNumber}&pager.offset=${pageNumber*10-10}" method="post" id="myform" onsubmit="return as()">
  ...
  <table border="1"  class="datagrid2" id="list" width="200px" cellspacing="0" style="float:left">
    ...
    <tr>
     ...
     <td width="70" align="right"><span class="STYLE2">备注</span></td>
      <td><textarea rows="5" cols="10" name="ordertable.remark">${updateId.remark}</textarea></td>
	</tr>
    <tr>    
