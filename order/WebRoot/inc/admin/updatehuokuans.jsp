...
<m:frame>
  ...
  <form action="admin!updatedingdansd.do?ordertable.id=${updateId.id}" method="post" id="myform" onsubmit="return as()">
  ...
  <table border="1"  class="datagrid2" id="list" cellspacing="0" style="float:left">
    ...
    <tr>
     ...
     <td width="54" align="right"><span class="STYLE2">货款</span></td>
      <td><input name="ordertable.huokuan" type="text" id="huokuan" size="12" title="货款" value="${updateId.huokuan}"></td>
	</tr>
    <tr>    
