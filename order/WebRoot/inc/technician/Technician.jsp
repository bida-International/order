...
<m:frame>
	<script type="text/javascript">
		 ...
		 function Audit(){
			...
			var lujing = "technician!audit.do?pageNumber="+${pageNumber}+"&pager.offset="+${pageNumber*10-10};
...
scrollbar-darkshadow-color: #FFFFFF;"> 
	 <form action="technician!getUnfinished.do"  name="forms" id="forms" method="post" onsubmit="return as()">
