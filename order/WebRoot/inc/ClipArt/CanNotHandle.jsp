...
//-->
	 ...
	 function quan()
	 {
	  ...
	  function chulis(){
	 	...
	 	var lujing = "clipart!upUntreated.do?pageNumber="+${pageNumber}+"&pager.offset="+${pageNumber*10-10};
	 	 bianhao(items,lujing);
	 }
</script>
<m:frame>

<form  action="clipart!CanNothandle.do" method="post" id="forms" name="forms">	
<table>
	<tr>
		<td>
			<input type="button" value="未处理" onclick="chulis()">
		</td>
	</tr>
</table>
  <table border="1"  width="700px" cellspacing="0" style="float:left" >
    <tr>
      <td colspan="5" align="center"><strong>得到不能处理订单</strong>
    </tr>
    <tr>
