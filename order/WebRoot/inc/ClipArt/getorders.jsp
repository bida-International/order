...
//-->
	 ...
	 function quan()
	 {
	  ...
	  function chulis(){
	 	...
	 	var lujing = "clipart!chuli.do?pageNumber="+${pageNumber}+"&pager.offset="+${pageNumber*10-10};
	 	 bianhao(items,lujing);
	 }
	 function CanNotHandle(){
	 	 var items=document.getElementsByName("chkItems"); 
	 	 var lujing = "clipart!upCanNotHandle.do?pageNumber="+${pageNumber}+"&pager.offset="+${pageNumber*10-10};
	 	 bianhao(items,lujing);
	 }
</script>
<m:frame>

<form  action="clipart!getorders.do" method="post" id="forms" name="forms">	
<table>
	<tr>
		<td>
		...
		<td>
			<input type="button" value="不能处理的订单" onclick="CanNotHandle()">
		</td>
	</tr>
</table>
