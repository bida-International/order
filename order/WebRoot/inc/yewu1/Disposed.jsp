...
//-->
	 ...
	 function quan()
	 {
	  ...
	  function Untreated(){
	 	...
	 	var lujing = "yewu1!untreated.do?pageNumber="+${pageNumber}+"&pager.offset="+${pageNumber*10-10};
	 	 bianhao(items,lujing);
	 }
</script>
<m:frame>

<form  action="yewu1!getBusinessDisposed.do" method="post" id="forms" name="forms">	
<table>
	<tr>
		<td>
			<input type="button" value="返回未处理" onclick="Untreated()">
		</td>
	</tr>
</table>
  <table border="1"  width="700px" cellspacing="0" style="float:left" >
    <tr>
      <td colspan="5" align="center"><strong>处理完毕的订单</strong>
    </tr>
    <tr>
    ...
    <td width="34" height="25">
     ...
     <td width="54"><span class="STYLE2">账号</span></td>
       ...
       <td width="90"><span class="STYLE2">上传日期</span></td>
