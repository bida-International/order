...
<script>
 function page(pageNumber) 
 {
   ...
   function chulis(){
	 	...
	 	var lujing = "yewu1!weichuli.do?time="+time+"&time1="+time1+"&zhanghaoId"+zhanghaoId+"&pageNumber="+${pageNumber}+"&pager.offset="+${pageNumber*10-10};
	 	 bianhao(items,lujing);
	 }	
</script>
<m:frame>
<form action="yewu1!getDisputesDealtWith.do" method="post" onsubmit="return as()" id="forms" name="forms">
  <table border="1" width="900px" cellspacing="0" style="float:left">
    <tr>
      <td colspan="9" align="center"><STRONG>纠纷处理完毕 </STRONG></td> 
    </tr>
    <tr>
      ...
      <input type="button" value="未处理完毕" style="cursor: pointer;" onclick="chulis()"/>
