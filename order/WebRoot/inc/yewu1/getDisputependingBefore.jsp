...
<script>
 function page(pageNumber) 
 {
   ...
   function chulis(){
	 	...
	 	var lujing = "yewu1!chuli.do?time="+time+"&time1="+time1+"&zhanghaoId"+zhanghaoId+"&pageNumber="+${pageNumber}+"&pager.offset="+${pageNumber*10-10};
	 	 bianhao(items,lujing);
	 }	
</script>
<m:frame>
<form action="yewu1!getDisputependingBefore.do" method="post" onsubmit="return as()" id="forms" name="forms">
  <table border="1" width="900px" cellspacing="0" style="float:left">
    <tr>
      <td colspan="11" align="center"><STRONG>纠纷未处理完毕 </STRONG></td> 
    </tr>
    <tr>
      <td colspan="11">订单号：<input type="text" name="orderId" id="orderId" value="${param.orderId}"/>
      ...
      <input type="button" value="处理完毕" style="cursor: pointer;" onclick="chulis()"/>
