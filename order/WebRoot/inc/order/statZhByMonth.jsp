...
<m:frame>
	<s:form action="./order/statZhByMonth.do">
		<table border="1" cellspacing="0" style="width: 99%; float: left">
			...
			<tr>
				<td colspan="5">
					...
					<a href="./order/statZhByDay.do?zhanghaoId=${zhanghaoId}" class="lbtn">按日统计</a>
					<a href="./order/statZhByWeek.do?zhanghaoId=${zhanghaoId}" class="lbtn">按周统计</a>	
					<a href="javascript:void(0)" class="lbtn selected">按月统计</a>
