...
<m:frame>
	<s:form action="./order/statZhByDay.do">
		<table border="1" cellspacing="0" style="width: 99%; float: left">
			...
			<tr>
				<td colspan="5">
					...
					<a href="javascript:void(0)" class="lbtn selected">按日统计</a>
					<a href="./order/statZhByWeek.do?zhanghaoId=${zhanghaoId}" class="lbtn">按周统计</a>
					<a href="./order/statZhByMonth.do?zhanghaoId=${zhanghaoId}" class="lbtn">按月统计</a>	
					<div style="float:left;">
						<span>统计账号：</span>
						<s:select name="zhanghaoId" list="zhangHaoList" listKey="id" listValue="account" value="zhanghaoId"></s:select>
						<span>&nbsp;&nbsp;</span>
						<span>统计时间：</span>
						<s:select name="statMonth" list="dates" value="statMonth"></s:select>
						<span>&nbsp;&nbsp;</span>
